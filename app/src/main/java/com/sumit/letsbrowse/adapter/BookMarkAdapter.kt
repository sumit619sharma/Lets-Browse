package com.sumit.letsbrowse.adapter
...
import com.sumit.letsbrowse.databinding.BookmarkViewBinding
import com.sumit.letsbrowse.databinding.LongBookmarkViewBinding
import com.sumit.letsbrowse.fragments.BrowseFragment

class BookMarkAdapter(private val context: Context,private var isActivity: Boolean): RecyclerView.Adapter<BookMarkAdapter.MyHolder>() {
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        try {
        // ---> convert byteArray to bitmap image ,then set image
            val icon = BitmapFactory.decodeByteArray(MainActivity.bookmarkList[position].image,
                      0,MainActivity.bookmarkList[position].image!!.size)
